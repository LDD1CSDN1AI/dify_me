...
Open [http://localhost:3000/agent-platform-web-yunpingtai/apps?console_token=xxxxx](http://localhost:3000/agent-platform-web-yunpingtai/apps?console_token=xxxx)这里带上启明大模型门户网站的 token.
